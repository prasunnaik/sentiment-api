...
# filename: application.yml | Code Generated by Sidekick is for learning and experimentation purposes only.
...
insurewise:
  security:
    issuer: ${JWT_ISSUER:insurewise}
    jwt-secret: ${JWT_SECRET:local-insurewise-jwt-secret-2026-development-only-change-before-use-123456789}
    token-ttl: ${JWT_TOKEN_TTL:8h}

  storage:
    bucket: ${S3_BUCKET:insurewise-local}
    region: ${AWS_REGION:us-east-1}
    presigned-url-ttl: ${S3_PRESIGNED_URL_TTL:15m}

# Compatibility properties for JwtService implementations
# that still use the older jwt.* configuration prefix.
jwt:
  issuer: ${JWT_ISSUER:insurewise}
  secret: ${JWT_SECRET:local-insurewise-jwt-secret-2026-development-only-change-before-use-123456789}
  expiration-hours: ${JWT_EXPIRATION_HOURS:8}

# S3 framework configuration
ng:
  file-upload:
    s3:
      enabled: ${S3_ENABLED:false}
      bucket-name: ${S3_BUCKET_NAME:insurewise-local}
      region: ${AWS_REGION:us-east-1}
      access-key: ${AWS_ACCESS_KEY_ID:}
      secret-key: ${AWS_SECRET_ACCESS_KEY:}
      endpoint: ${S3_ENDPOINT:}
      path-style-access-enabled: ${S3_PATH_STYLE_ACCESS_ENABLED:false}
      key-prefix: ${S3_KEY_PREFIX:insurewise}

      download:
        enabled: ${S3_DOWNLOAD_ENABLED:false}
...
# filename: .env | Code Generated by Sidekick is for learning and experimentation purposes only.
...
JWT_ISSUER=insurewise
JWT_SECRET=local-insurewise-jwt-secret-2026-development-only-change-before-use-123456789
JWT_TOKEN_TTL=8h
...
S3_ENABLED=false
S3_BUCKET=insurewise-local
S3_BUCKET_NAME=insurewise-local
AWS_REGION=us-east-1
AWS_ACCESS_KEY_ID=
AWS_SECRET_ACCESS_KEY=
S3_ENDPOINT=
S3_PATH_STYLE_ACCESS_ENABLED=false
S3_KEY_PREFIX=insurewise
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.insurewise</groupId>
    <artifactId>insurewise-service</artifactId>
    <version>1.0.0-SNAPSHOT</version>

    <name>insurewise-service</name>
    <description>InsureWise insurance policy management service</description>
    ...
    <properties>
        ...
        <s3-framework.version>1.0.0-SNAPSHOT</s3-framework.version>
    </properties>
